...
namespace WzComparerR2
{
    public partial class MainForm : Office2007RibbonForm, PluginContextProvider
    {
        ...
        void SavePngButtonClickNew(object sender, EventArgs e)
        {
            ...
            //OutputPng("Longcoat", 01000000, 01053000);
            //OutputPng("Pants", 01060000, 01063000);
            //OutputPng("Shoes", 01070000, 01073000);
            //OutputPng("Shield", 01090000, 01093000);
            //OutputPng("Hair", 00030000, 00032000);
        ...
        void SavePngButtonClick_OutputCap(object sender, EventArgs e)
        {
            string p = "Character/Cap/";
